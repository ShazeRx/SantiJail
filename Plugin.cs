...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .santijail-example "some quoted string" 1 1.5
    // /// .santijail-example boop 21232
    // /// .santijail-example boop-boop
    // ///</remarks>
    // [Command("santijail-example", description: "Example command from santijail", adminOnly: true)]
